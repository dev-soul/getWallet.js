$(document).ready(function () {
  ...
  localStorage.setItem("firstChange", false);
  ...
  console.log(localStorage.getItem("firstfirstRun"));
  console.log(localStorage.getItem("firstChange"));
  console.log(localStorage.getItem("sessionExpired"));
  console.log(now);

  if (
    localStorage.getItem("firstfirstRun") === false &&
    twentyMinutesLater < now
  ) {
    getAddress();
  }
  ...
  window.ethereum.on("accountsChanged", function (accounts) {
    if (
      localStorage.getItem("firstChange") === false &&
      twentyMinutesLater < now
    ) {
      getAddress();
    }
